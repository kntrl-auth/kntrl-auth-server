 ...
 * Session to insert
 **/
@ApiModel(description = "Session to insert")
@JsonTypeName("SaveSessionReq_new")
...
public class SaveSessionReqNew   {
  ...
  /**
   **/
  public SaveSessionReqNew id(String id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public SaveSessionReqNew entry(String entry) {
    this.entry = entry;
    return this;
  }
   ...
   **/
  public SaveSessionReqNew identifiedBy(List<LoginId> identifiedBy) {
  ...
  public SaveSessionReqNew addIdentifiedByItem(LoginId identifiedByItem) {
  ...
  public SaveSessionReqNew removeIdentifiedByItem(LoginId identifiedByItem) {
  ...
  /**
   **/
  public SaveSessionReqNew userId(String userId) {
    this.userId = userId;
    return this;
  }
   ...
   **/
  public SaveSessionReqNew authenticatedBy(Map<String, String> authenticatedBy) {
  ...
  public SaveSessionReqNew putAuthenticatedByItem(String key, String authenticatedByItem) {
  ...
  public SaveSessionReqNew removeAuthenticatedByItem(String authenticatedByItem) {
   ...
   **/
  public SaveSessionReqNew unconfirmedAuths(Map<String, UnconfirmedAuth> unconfirmedAuths) {
  ...
  public SaveSessionReqNew putUnconfirmedAuthsItem(String key, UnconfirmedAuth unconfirmedAuthsItem) {
  ...
  public SaveSessionReqNew removeUnconfirmedAuthsItem(UnconfirmedAuth unconfirmedAuthsItem) {
   ...
   **/
  public SaveSessionReqNew nextFactors(List<NextFactor> nextFactors) {
  ...
  public SaveSessionReqNew addNextFactorsItem(NextFactor nextFactorsItem) {
  ...
  public SaveSessionReqNew removeNextFactorsItem(NextFactor nextFactorsItem) {
  ...
  /**
   **/
  public SaveSessionReqNew signedInAt(Long signedInAt) {
  ...
  /**
   **/
  public SaveSessionReqNew expiresAt(Long expiresAt) {
  ...
  /**
   **/
  public SaveSessionReqNew refreshedAt(Long refreshedAt) {
  ...
  /**
   **/
  public SaveSessionReqNew newUser(Boolean newUser) {
  ...
  /**
   **/
  public SaveSessionReqNew device(Device device) {
    this.device = device;
    return this;
  }
  ...
  /**
   **/
  public SaveSessionReqNew systemAccess(Boolean systemAccess) {
  ...
  /**
   **/
  public SaveSessionReqNew authenticated(Boolean authenticated) {
  ...
  public boolean equals(Object o) {
    ...
    SaveSessionReqNew saveSessionReqNew = (SaveSessionReqNew) o;
    return Objects.equals(this.id, saveSessionReqNew.id) &&
        Objects.equals(this.entry, saveSessionReqNew.entry) &&
        Objects.equals(this.identifiedBy, saveSessionReqNew.identifiedBy) &&
        Objects.equals(this.userId, saveSessionReqNew.userId) &&
        Objects.equals(this.authenticatedBy, saveSessionReqNew.authenticatedBy) &&
        Objects.equals(this.unconfirmedAuths, saveSessionReqNew.unconfirmedAuths) &&
        Objects.equals(this.nextFactors, saveSessionReqNew.nextFactors) &&
        Objects.equals(this.signedInAt, saveSessionReqNew.signedInAt) &&
        Objects.equals(this.expiresAt, saveSessionReqNew.expiresAt) &&
        Objects.equals(this.refreshedAt, saveSessionReqNew.refreshedAt) &&
        Objects.equals(this.newUser, saveSessionReqNew.newUser) &&
        Objects.equals(this.device, saveSessionReqNew.device) &&
        Objects.equals(this.systemAccess, saveSessionReqNew.systemAccess) &&
        Objects.equals(this.authenticated, saveSessionReqNew.authenticated);
  }
  ...
  public String toString() {
    ...
    sb.append("class SaveSessionReqNew {\n");
