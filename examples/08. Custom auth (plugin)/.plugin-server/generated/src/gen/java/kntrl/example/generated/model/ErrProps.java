...
/**
 * Gets or Sets ErrProps
 */
public enum ErrProps {
  ...
  ErrProps(String value) {
     ...
     */
	public static ErrProps fromString(String s) {
      for (ErrProps b : ErrProps.values()) {
  ...
  @JsonCreator
  public static ErrProps fromValue(String value) {
    for (ErrProps b : ErrProps.values()) {
