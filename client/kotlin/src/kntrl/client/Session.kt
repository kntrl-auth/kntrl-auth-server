...
import kntrl.client.generated.api.SessionApi
import kntrl.client.generated.api.TokenApi
import kntrl.client.generated.infra.ApiClient
import kntrl.client.generated.model.*
import java.time.OffsetDateTime
import java.time.ZoneOffset
import kntrl.client.generated.model.Session as SessionModel
...
class Session(
    ...
    fun confirm(receivedCodes: Map<String, Map<String, String>>): AuthenticateRes = handleErr {
        val res = sessionApi.confirmSessionAuths(ConfirmSessionAuthsReq().receivedCodes(receivedCodes))
        update(res.tokens, res.session)
        res
    }
    ...
    fun newSession(entry: String) = Session(client, accessToken, NewSessionReq().entry(entry).signIn(true))
