...
export interface AuthExecResResData {
    ...
    'redirectUris'?: Array<string>;
    /**
     * Provided only when generated first time or generated again.
     * @type {string}
     * @memberof AuthExecResResData
     */
    'clientSecret'?: string;
...
export interface AuthUserCfg {
    /**
     * 
     * @type {AuthUserCfgData}
     * @memberof AuthUserCfg
     */
    'data'?: AuthUserCfgData;
    /**
...
/**
 * Data/State of this authenticator
 * @export
 * @interface AuthUserCfgData
 */
export interface AuthUserCfgData {
    /**
     * 
     * @type {AuthDataPublic}
     * @memberof AuthUserCfgData
     */
    'public': AuthDataPublic;
    /**
     * If authenticator supports identification, it provides login here. This can be email, phone number, facebook account id, etc.
 ...
 * 
 * @export
 * @interface AuthorizationCodeAuthCfg
 */
export interface AuthorizationCodeAuthCfg {
    /**
     * If this is not null, app forbids to add this auth until listed auth enabled. - if this a string -> require specified auth to be enabled before this. - array of strings -> require any of listed auths to be enabled - array of arrays of strings -> works as `[ [ \"auth1\" and \"auth2\" ] or [ \"auth1\" and \"auth2\" ] ]`
     * @type {Array<Array<string>>}
     * @memberof AuthorizationCodeAuthCfg
     */
    'requiresAuth'?: Array<Array<string>>;
    /**
     * When this is set to true app will attempt next auth in case of error on current. It\'s works good with IP auth. User can provide both IP auth request and SMS auth request. And SMS will be executed only when IP auth is failed. If set to false any error on this auth will stop the whole request execution.
 ...
 * 
 * @export
 * @interface AuthorizationCodeAuthReqData
 */
export interface AuthorizationCodeAuthReqData {
    [key: string]: any;

    /**
     * Authorization code provided by `authorizationCode` update request.
     * @type {string}
     * @memberof AuthorizationCodeAuthReqData
     */
    'authorizationCode': string;
    /**
     * Access token of user that will be able to act of behalf of current user.
 ...
 * 
 * @export
 * @interface AuthorizationCodeSessionData
 */
export interface AuthorizationCodeSessionData {
    [key: string]: any;

    /**
     * 
     * @type {Array<LoginId>}
     * @memberof AuthorizationCodeSessionData
     */
    'agent': Array<LoginId>;
    /**
     * 
 ...
 * 
 * @export
 * @interface AuthorizationCodeUpdateReqData
 */
export interface AuthorizationCodeUpdateReqData {
    [key: string]: any;

    /**
     * Login or logins of the user that will get access-token and be able to act of behalf of current user.
     * @type {Array<LoginId>}
     * @memberof AuthorizationCodeUpdateReqData
     */
    'agentLogins': Array<LoginId>;
    /**
     * 
 ...
 * 
 * @export
 * @interface AuthorizationCodeUpdateResData
 */
export interface AuthorizationCodeUpdateResData {
    [key: string]: any;

    /**
     * 
     * @type {string}
     * @memberof AuthorizationCodeUpdateResData
     */
    'authorizationCode': string;
}
/**
...
export interface ClientErr {
     ...
     * @memberof ClientErr
     */
    'incorrectRedirectUri'?: boolean;
    /**
     * 
     * @type {boolean}
     * @memberof ClientErr
     */
    'incorrectSecret'?: boolean;
    /**
     * 
     * @type {number}
     * @memberof ClientErr
    ...
    /**
     * Token expiration time. If null, token is incorrect (due to incorrect format or invalid signature). May be caused by changed app-secret.
     * @type {number}
     * @memberof ClientErr
     */
    'expiredAt'?: number;
 ...
 * 
 * @export
 * @interface IncorrectTotpCode
 */
export interface IncorrectTotpCode {
    /**
     * 
     * @type {string}
     * @memberof IncorrectTotpCode
     */
    'code': string;
    /**
     * Message for developers.
...
export interface Login {
    ...
    'login': string;
    /**
     * Login that waits for confirmation.
     * @type {string}
     * @memberof Login
     */
 ...
 * 
 * @export
 * @interface OAuthAppAuthCfg
 */
export interface OAuthAppAuthCfg {
    /**
     * If this is not null, app forbids to add this auth until listed auth enabled. - if this a string -> require specified auth to be enabled before this. - array of strings -> require any of listed auths to be enabled - array of arrays of strings -> works as `[ [ \"auth1\" and \"auth2\" ] or [ \"auth1\" and \"auth2\" ] ]`
     * @type {Array<Array<string>>}
     * @memberof OAuthAppAuthCfg
     */
    'requiresAuth'?: Array<Array<string>>;
    /**
     * When this is set to true app will attempt next auth in case of error on current. It\'s works good with IP auth. User can provide both IP auth request and SMS auth request. And SMS will be executed only when IP auth is failed. If set to false any error on this auth will stop the whole request execution.
 ...
 * 
 * @export
 * @interface OAuthAppAuthReqData
 */
export interface OAuthAppAuthReqData {
    [key: string]: any;

    /**
     * 
     * @type {string}
     * @memberof OAuthAppAuthReqData
     */
    'clientId': string;
    /**
     * 
 ...
 * Data available only for authenticator.
 * @export
 * @interface OAuthAppPrivateData
 */
export interface OAuthAppPrivateData {
    [key: string]: any;

    /**
     * 
     * @type {string}
     * @memberof OAuthAppPrivateData
     */
    'secretHash': string;
}
/**
 * Data that are available for API.
 * @export
 * @interface OAuthAppPublicData
 */
export interface OAuthAppPublicData {
    [key: string]: any;

    /**
     * 
     * @type {Array<string>}
     * @memberof OAuthAppPublicData
     */
    'redirectUris'?: Array<string>;
}
/**
 * 
 * @export
 * @interface OAuthAppUpdateReqData
 */
export interface OAuthAppUpdateReqData {
    [key: string]: any;

    /**
     * Null - don\'t validate redirectUrl, empty array will lead to all authenticate request fail.
     * @type {Array<string>}
     * @memberof OAuthAppUpdateReqData
     */
    'redirectUris'?: Array<string>;
    /**
     * If previous secret lost or compromised, it allows to generate a new one.
 ...
 * 
 * @export
 * @interface OAuthAppUpdateResData
 */
export interface OAuthAppUpdateResData {
    [key: string]: any;

    /**
     * 
     * @type {string}
     * @memberof OAuthAppUpdateResData
     */
    'clientId': string;
    /**
     * 
 ...
 * 
 * @export
 * @interface OauthAppErr
 */
export interface OauthAppErr {
    /**
     * 
     * @type {string}
     * @memberof OauthAppErr
     */
    'code': string;
    /**
     * Message for developers.
 ...
 * 
 * @export
 * @interface ScopesAuthCfg
 */
export interface ScopesAuthCfg {
    /**
     * If this is not null, app forbids to add this auth until listed auth enabled. - if this a string -> require specified auth to be enabled before this. - array of strings -> require any of listed auths to be enabled - array of arrays of strings -> works as `[ [ \"auth1\" and \"auth2\" ] or [ \"auth1\" and \"auth2\" ] ]`
     * @type {Array<Array<string>>}
     * @memberof ScopesAuthCfg
     */
    'requiresAuth'?: Array<Array<string>>;
    /**
     * When this is set to true app will attempt next auth in case of error on current. It\'s works good with IP auth. User can provide both IP auth request and SMS auth request. And SMS will be executed only when IP auth is failed. If set to false any error on this auth will stop the whole request execution.
 ...
 * 
 * @export
 * @interface ScopesAuthReqData
 */
export interface ScopesAuthReqData {
    [key: string]: any;

    /**
     * Login or logins of the user that will get access-token and be able to act of behalf of current user.
     * @type {Array<LoginId>}
     * @memberof ScopesAuthReqData
     */
    'agentLogins'?: Array<LoginId>;
    /**
     * 
 ...
 * 
 * @export
 * @interface ScopesSessionData
 */
export interface ScopesSessionData {
    [key: string]: any;

    /**
     * 
     * @type {Array<LoginId>}
     * @memberof ScopesSessionData
     */
    'agent'?: Array<LoginId>;
    /**
     * 
...
export interface Session {
    ...
    /**
     * 
     * @type {{ [key: string]: SessionDataValue; }}
     * @memberof Session
     */
    'data': { [key: string]: SessionDataValue; };
    /**
     * 
     * @type {boolean}
     * @memberof Session
 ...
 * 
 * @export
 * @interface TotpAuthCfg
 */
export interface TotpAuthCfg {
    /**
     * If this is not null, app forbids to add this auth until listed auth enabled. - if this a string -> require specified auth to be enabled before this. - array of strings -> require any of listed auths to be enabled - array of arrays of strings -> works as `[ [ \"auth1\" and \"auth2\" ] or [ \"auth1\" and \"auth2\" ] ]`
     * @type {Array<Array<string>>}
     * @memberof TotpAuthCfg
     */
    'requiresAuth'?: Array<Array<string>>;
    /**
     * When this is set to true app will attempt next auth in case of error on current. It\'s works good with IP auth. User can provide both IP auth request and SMS auth request. And SMS will be executed only when IP auth is failed. If set to false any error on this auth will stop the whole request execution.
 ...
 * 
 * @export
 * @interface TotpAuthReqData
 */
export interface TotpAuthReqData {
    [key: string]: any;

    /**
     * 
     * @type {string}
     * @memberof TotpAuthReqData
     */
    'code': string;
}
/**
 * Data available only for authenticator.
 * @export
 * @interface TotpPrivateDate
 */
export interface TotpPrivateDate {
    [key: string]: any;

    /**
     * 
     * @type {string}
     * @memberof TotpPrivateDate
     */
    'secret': string;
}
/**
 * 
 * @export
 * @interface TotpUpdateReqData
 */
export interface TotpUpdateReqData {
    [key: string]: any;

    /**
     * Base32 SHA-1 key. If null, secret is generated automatically.
     * @type {string}
     * @memberof TotpUpdateReqData
     */
    'secret'?: string;
    /**
     * Used only to generate `otpauth://` url.
 ...
 * 
 * @export
 * @interface TotpUpdateResData
 */
export interface TotpUpdateResData {
    [key: string]: any;

    /**
     * Base32 SHA-1 key.
     * @type {string}
     * @memberof TotpUpdateResData
     */
    'secret': string;
    /**
     * 
...
/**
 * CustomTokenApi - axios parameter creator
 * @export
 */
export const CustomTokenApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         ...
         * @throws {RequiredError}
         */
        createCustomBinaryToken: async (body: string, secret?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            assertParamExists('createCustomBinaryToken', 'body', body)
            const localVarPath = `/api/tokens/custom/binary`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        createCustomJwtToken: async (requestBody: { [key: string]: any; }, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'requestBody' is not null or undefined
            assertParamExists('createCustomJwtToken', 'requestBody', requestBody)
            const localVarPath = `/api/tokens/custom/jwt`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getCustomJwtPublicKey: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/tokens/custom/jwt/public-key`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        parseCustomBinaryToken: async (body: string, secret?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            assertParamExists('parseCustomBinaryToken', 'body', body)
            const localVarPath = `/api/tokens/custom/binary/parse`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        parseCustomJwtToken: async (body: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'body' is not null or undefined
            assertParamExists('parseCustomJwtToken', 'body', body)
            const localVarPath = `/api/tokens/custom/jwt/parse`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
/**
 * CustomTokenApi - functional programming interface
 * @export
 */
export const CustomTokenApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = CustomTokenApiAxiosParamCreator(configuration)
    return {
        /**
         * Creates binary token signed with specified secret. When secret is null - use app secret (specified in kntrl.json5) with SHA256withRSA algorithm. Otherwise - use secret from query and sign with HmacSHA256 algorithm. 
         * @summary (Backend API) Create binary token
         ...
         * @throws {RequiredError}
         */
        async createCustomBinaryToken(body: string, secret?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createCustomBinaryToken(body, secret, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Creates JWT token signed with RSA256 key. RSA key is generated from app secret (specified in kntrl.json5) 
         ...
         * @throws {RequiredError}
         */
        async createCustomJwtToken(requestBody: { [key: string]: any; }, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createCustomJwtToken(requestBody, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * RSA256 public key generated from app-secret from config used for signature validation. Can be used to verify jwt tokens locally. 
         ...
         * @throws {RequiredError}
         */
        async getCustomJwtPublicKey(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getCustomJwtPublicKey(options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Validates token signature and extracts token data. See /binary API for details. 
         ...
         * @throws {RequiredError}
         */
        async parseCustomBinaryToken(body: string, secret?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.parseCustomBinaryToken(body, secret, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Validates token signature, expiration time and extracts token data. See /jwt API for details. 
         ...
         * @throws {RequiredError}
         */
        async parseCustomJwtToken(body: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.parseCustomJwtToken(body, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
/**
 * CustomTokenApi - factory interface
 * @export
 */
export const CustomTokenApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = CustomTokenApiFp(configuration)
    return {
        /**
         * Creates binary token signed with specified secret. When secret is null - use app secret (specified in kntrl.json5) with SHA256withRSA algorithm. Otherwise - use secret from query and sign with HmacSHA256 algorithm. 
         * @summary (Backend API) Create binary token
         ...
         * @throws {RequiredError}
         */
        createCustomBinaryToken(body: string, secret?: string, options?: any): AxiosPromise<string> {
            return localVarFp.createCustomBinaryToken(body, secret, options).then((request) => request(axios, basePath));
        },
        /**
         * Creates JWT token signed with RSA256 key. RSA key is generated from app secret (specified in kntrl.json5) 
         * @summary (Backend API) Create JWT token
         ...
         * @throws {RequiredError}
         */
        createCustomJwtToken(requestBody: { [key: string]: any; }, options?: any): AxiosPromise<string> {
            return localVarFp.createCustomJwtToken(requestBody, options).then((request) => request(axios, basePath));
        },
        /**
         * RSA256 public key generated from app-secret from config used for signature validation. Can be used to verify jwt tokens locally. 
         * @summary Get JWT public key
         ...
         * @throws {RequiredError}
         */
        getCustomJwtPublicKey(options?: any): AxiosPromise<string> {
            return localVarFp.getCustomJwtPublicKey(options).then((request) => request(axios, basePath));
        },
        /**
         * Validates token signature and extracts token data. See /binary API for details. 
         * @summary Parse binary token
         ...
         * @throws {RequiredError}
         */
        parseCustomBinaryToken(body: string, secret?: string, options?: any): AxiosPromise<string> {
            return localVarFp.parseCustomBinaryToken(body, secret, options).then((request) => request(axios, basePath));
        },
        /**
         * Validates token signature, expiration time and extracts token data. See /jwt API for details. 
         * @summary Parse JWT token
         ...
         * @throws {RequiredError}
         */
        parseCustomJwtToken(body: string, options?: any): AxiosPromise<string> {
            return localVarFp.parseCustomJwtToken(body, options).then((request) => request(axios, basePath));
        },
    };
};

/**
 * CustomTokenApi - object-oriented interface
 * @export
 * @class CustomTokenApi
 * @extends {BaseAPI}
 */
export class CustomTokenApi extends BaseAPI {
    /**
     * Creates binary token signed with specified secret. When secret is null - use app secret (specified in kntrl.json5) with SHA256withRSA algorithm. Otherwise - use secret from query and sign with HmacSHA256 algorithm. 
     * @summary (Backend API) Create binary token
     * @param {string} body 
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof CustomTokenApi
     */
    public createCustomBinaryToken(body: string, secret?: string, options?: AxiosRequestConfig) {
        return CustomTokenApiFp(this.configuration).createCustomBinaryToken(body, secret, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CustomTokenApi
     */
    public createCustomJwtToken(requestBody: { [key: string]: any; }, options?: AxiosRequestConfig) {
        return CustomTokenApiFp(this.configuration).createCustomJwtToken(requestBody, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CustomTokenApi
     */
    public getCustomJwtPublicKey(options?: AxiosRequestConfig) {
        return CustomTokenApiFp(this.configuration).getCustomJwtPublicKey(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CustomTokenApi
     */
    public parseCustomBinaryToken(body: string, secret?: string, options?: AxiosRequestConfig) {
        return CustomTokenApiFp(this.configuration).parseCustomBinaryToken(body, secret, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CustomTokenApi
     */
    public parseCustomJwtToken(body: string, options?: AxiosRequestConfig) {
        return CustomTokenApiFp(this.configuration).parseCustomJwtToken(body, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const TokenApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getPublicKey: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/token/jwt/public-key`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export class TokenApi extends BaseAPI {
    ...
    public getPublicKey(options?: AxiosRequestConfig) {
        return TokenApiFp(this.configuration).getPublicKey(options).then((request) => request(this.axios, this.basePath));
    }
